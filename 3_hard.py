...
lname = input ('Введите свою фамилию: ')
age = int(input ('Ваш возраст: '))
weight = int(input ('Ваш вес: '))

if age < 30 and weight >= 50 and weight <= 120:
    print (name, lname+',', age, 'год, вес', weight, '- хорошее состояние')
elif age > 30 and weight <= 50 or weight >= 120:
    print(name, lname + ',', age, 'год, вес', weight, '- cледует заняться собой')
elif age > 40 and weight <= 50 or weight >= 120:
    print(name, lname + ',', age, 'год, вес', weight, '- следует обратится к врачу!')