...
while number < 0 or number > 10:
    print('Число не верное, требуется ввести число в диапозоне от 0 до 10')
    number = int(input('Введите число повтроно: '))

print('Ваше число возведенное во вторую степень =', number ** 2)
...
b = a - b
a = a - b
print('новое значение первой переменной', a, ' а второй переменной', b )
